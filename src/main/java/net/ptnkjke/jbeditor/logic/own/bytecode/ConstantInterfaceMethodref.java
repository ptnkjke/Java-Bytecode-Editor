...
public class ConstantInterfaceMethodref extends AbstractConstant {
    private static final Pattern pattern = Pattern.compile("ConstantInterfaceMethodref\\ +(\\d)+\\ +(\\d)+");

    private int class_index;
    private int name_and_type_index;

    protected ConstantInterfaceMethodref() {
        super(Constants.CONSTANT_InterfaceMethodref);
    }

    public ConstantInterfaceMethodref(DataInput file) throws IOException {
        this();
    ...
    public String toLineCode() {
        return "ConstantInterfaceMethodref " + class_index + " " + name_and_type_index;
    }
    ...
    public static AbstractConstant parseLine(String lineCode) {
        ...
        ConstantInterfaceMethodref cons = new ConstantInterfaceMethodref();
